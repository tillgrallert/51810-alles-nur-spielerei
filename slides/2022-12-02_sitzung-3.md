...
<cite>@Grusin+2014, 83</cite>

# 2. DH as methodological approaches
...
<cite>@SchreibmanEtAl2016Preface, xvii</cite>
...
<cite>@SchreibmanEtAl2004Intro, xxvi</cite>
...
<cite>@Battershill+2017, 3-4</cite>
...
![Global [map of DH centers](http://dhcenternet.org/centers)](https://tillgrallert.github.io/slides/assets/dh/map_dhcenters.png)

## DH as a community

![ [Around DH in 80 Days](http://www.arounddh.org/), 2014](https://tillgrallert.github.io/slides/assets/dh/map_arounddh.png)
...
- the myth of father Busa and the Index Thomisticus
...
+ ["Zeitschrift für digitale Geisteswissenschaften" (ZfdG)](https://zfdg.de), 2016
...
[Click here](https://furesh.github.io/slides/2022-11-23-coffee-lecture)
...
- Ziel des Projektseminars Entwicklunge einer gamifizierten User Survey
- Ziel des Surveys: "Erstanamese" der Nutzer_in: 
    * Welche Bedürfnisse hat diese Nutzer_in, wenn er den Scholarly Makerspace besucht?
    * Welche Kenntnisse bringt diese Nutzer_in mit?
    * Welcher Nutzertyp kann dem Nutzer_in zugeordnet werden?
...
## 1. Inhaltliche Umsetzung
### 1.2 Entwicklung des Surveys

* Machen Sie sich Gedanken, welche Antworten wir konkret von den Nutzer:innen brauchen, um die Fragen aus der "Erstanamese" zu beantworten. Welche Fragen wären sinnvoll zu stellen?
* Ordnen Sie die Fragen in Themenblöcke ein
* Erstellen Sie eine erste Reihenfolge für diese Themenblöcke

## 2. Technisches Umsetzung

Wie wollen Sie ihre gamifizierte Usersurvey umsetzen? 

- Entwickeln Sie einen (oder mehrere Vorschläge) für eine mögliche Umsetzung.
- Überlegen Sie, welche Möglchkeiten Ihnen zur Verfügung stehen? 
    + Welche Tools gibt es? 
    + Was benötigen Sie, um die Tools zu nutzen?
